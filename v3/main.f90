...
case ('geometry')
  ...
  print *, "***calling read_xml_file_geometry (v3) with filesize = ", fsize
  call benchmark_geometry(time)
  print *, 'read_xml_file_geometry (v3) completed in (seconds):', time
...
case ('tallies')
  ...
  print *, "***calling read_xml_file_tallies (v3) with filesize = ", fsize
  call benchmark_tallies(time)
  print *, 'read_xml_file_tallies (v3) completed in (seconds):', time
